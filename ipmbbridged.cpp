...
static const std::map<std::string, ipmbChannelType> ipmbChannelTypeMap = {
    {"me", ipmbChannelType::me}, {"ipmb", ipmbChannelType::ipmb}};
...
static int initializeChannels()
{
    ...
    constexpr char *config_file_path = "/usr/share/ipmb-channels.json";
